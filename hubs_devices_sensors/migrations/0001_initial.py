    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensors_data_fetch_time', models.DurationField(default=datetime.timedelta(0), verbose_name='Sensors Data Fetch Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('devices_data_fetch_time', models.DurationField(default=datetime.timedelta(0), verbose_name='Devices Data Fetch Time')),
                ('hub_data_update_time', models.DurationField(default=datetime.timedelta(0), verbose_name='Hub Data Update Time')),
